...
![Final](/assets/images/shelf/demo.png){:width="600"}
...
![Sketch](/assets/images/shelf/sketch.png){:width="600"}

## Force Analysis
Free body diagrams were used to determine the force that will be applied on the shelf.

![FBD](/assets/images/shelf/force.png){:width="600"}
...
![Shape Optimization Iteration](/assets/images/shelf/iterations.jpg){:width="600"}
...
![Printed Prototype](/assets/images/shelf/prototype.png){:width="600"}
...
![CAD Before](/assets/images/shelf/cad-before.png){:width="600"}

![Stress Original](/assets/images/shelf/stress-og.png){:width="600"}

![Shape Optimization](/assets/images/shelf/shape-op.png){:width="600"}

![CAD After](/assets/images/shelf/cad-after.png){:width="600"}

![Stress Normal](/assets/images/shelf/stress-normal.png){:width="600"}

![Stress Improper](/assets/images/shelf/stress-improper.png){:width="600"}
