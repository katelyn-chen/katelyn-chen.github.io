...
![Concept](/assets/images/matcar/concept.png){:width="600"}

![CAD Design](/assets/images/matcar/cad.png){:width="600"}

![Laser Cut Prototype](/assets/images/matcar/lasercut.png){:width="600"}

![Material Analysis](/assets/images/matcar/materialanalysis1.png){:width="600"}

![Material Analysis Cont.](/assets/images/matcar/materialanalysis2.png){:width="600"}

![Simulation 1](/assets/images/matcar/simulation1.png){:width="600"}

![Simulation 2](/assets/images/matcar/simulation2.png){:width="600"}
...
![CAD Assembly](/assets/images/matcar/cad-assembly.png){:width="600"}
{% include gallery %}

![Final Pictures](/assets/images/matcar/pics.png){:width="600"}
